$('.submenu li:nth-child(1) div').css('background' , 'rgba(245,213,85,1)').css('width' , '12px').css('height' , '12px');
...
$(window).on('scroll' , function(){
    if(window.scrollY < window.innerHeight/2){
        ...
        $('.submenu li:nth-child(2) div').css('background' , 'rgba(245,213,85,1)').css('width' , '12px').css('height' , '12px');;
    }
        ...
        $('.submenu li:nth-child(3) div').css('background' , 'rgba(245,213,85,1)').css('width' , '12px').css('height' , '12px');;
    }
        ...
        $('.submenu li:nth-child(4) div').css('background' , 'rgba(245,213,85,1)').css('width' , '12px').css('height' , '12px');;
    }
})
